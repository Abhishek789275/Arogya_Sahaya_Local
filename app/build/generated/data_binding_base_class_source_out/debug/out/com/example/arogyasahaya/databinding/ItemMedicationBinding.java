...
public final class ItemMedicationBinding implements ViewBinding {
  ...
  private ItemMedicationBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnDelete,
  ...
  public static ItemMedicationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMedicationBinding((MaterialCardView) rootView, btnDelete, tvMedDosage,
          tvMedName, tvMedTime);
    }
