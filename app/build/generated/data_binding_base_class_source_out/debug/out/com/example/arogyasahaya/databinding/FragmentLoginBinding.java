...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText etLoginContact;
  ...
  private FragmentLoginBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      @NonNull TextInputEditText etLoginContact, @NonNull TextInputEditText etLoginPassword,
      @NonNull TextView tvGoToRegister) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.etLoginContact = etLoginContact;
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etLoginContact;
      TextInputEditText etLoginContact = ViewBindings.findChildViewById(rootView, id);
      if (etLoginContact == null) {
        break missingId;
      }
      ...
      return new FragmentLoginBinding((LinearLayout) rootView, btnLogin, etLoginContact,
          etLoginPassword, tvGoToRegister);
    }
